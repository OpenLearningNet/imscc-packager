...
import { getRandomNumberInRange, toKebabCase } from "../../common";
import {
  badges,
  completion,
  files,
...
export async function packageMoodleQuizContent(
  ...
  const activitTitle = `${title} - Generated by app.coursemagic.ai`;
  ...
  */
  ...
  const moodleBackupXml = moodleBackup({
    backUpName: `backup-moodle2-${toKebabCase(page.title)}`,
    quizActivityFolderName: `quiz_${moduleId}`,
    moduleId: moduleId.toString(),
    sectionId: sectionId.toString(),
    activitTitle: activitTitle,
  });
