export function quiz() {
  ...
  <activity id="11" moduleid="436" modulename="quiz" contextid="605">
    <quiz id="11">
      <name>Section Content Title for Quiz</name>
      <intro></intro>
      ...
      <question_instances>
        <question_instance id="38">
          ...
          <question_reference id="38">
            <usingcontextid>605</usingcontextid>
